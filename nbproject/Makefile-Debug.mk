...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/z1prot_sim: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/z1prot_sim ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/src/dispatch.o: src/dispatch.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dispatch.o src/dispatch.c
...
${OBJECTDIR}/src/net/comm.o: src/net/comm.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/net/comm.o src/net/comm.c

${OBJECTDIR}/src/net/queue.o: src/net/queue.c
	${MKDIR} -p ${OBJECTDIR}/src/net
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/net/queue.o src/net/queue.c

${OBJECTDIR}/src/net/security.o: src/net/security.c
	${MKDIR} -p ${OBJECTDIR}/src/net
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/net/security.o src/net/security.c

${OBJECTDIR}/src/net/transport.o: src/net/transport.c
	${MKDIR} -p ${OBJECTDIR}/src/net
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/net/transport.o src/net/transport.c

${OBJECTDIR}/src/server.o: src/server.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/server.o src/server.c
